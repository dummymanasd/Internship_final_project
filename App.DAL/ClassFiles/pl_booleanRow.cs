// <fileinfo name="pl_booleanRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="pl_booleanRow"/> that 
	/// represents a record in the <c>pl_boolean</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="pl_booleanRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public  class pl_booleanRow
	{
		private long _table_pid;
		private bool _table_pidNull = true;
		private string _column_type;
		private bool _data_value;
		private bool _data_valueNull = true;

		/// <summary>
		/// Initializes a new instance of the <see cref="pl_booleanRow"/> class.
		/// </summary>
		public pl_booleanRow()
		{
			// EMPTY
		}
	...
	} // End of pl_booleanRow_Base class
} // End of namespace
