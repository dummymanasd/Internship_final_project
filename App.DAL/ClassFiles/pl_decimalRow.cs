// <fileinfo name="pl_decimalRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="pl_decimalRow"/> that 
	/// represents a record in the <c>pl_decimal</c> table.
	/// </summary>
	/// <remarks>
	...
	public  class pl_decimalRow
	{
		...
		private decimal _data_value;
		private bool _data_valueNull = true;

		/// <summary>
		/// Initializes a new instance of the <see cref="pl_decimalRow"/> class.
		/// </summary>
		public pl_decimalRow()
		{
			// EMPTY
		}
	...
	} // End of pl_decimalRow_Base class
} // End of namespace
